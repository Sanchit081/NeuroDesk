...
const Footer = () => {
  return (
    <footer className="relative bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white overflow-hidden">
      {/* Large SanchitVerse Background Text */}
      <div className="absolute inset-0 flex items-center justify-end pr-8 pointer-events-none">
        <motion.div
          ...
          viewport={{ once: true }}
          className="text-[12rem] md:text-[16rem] lg:text-[20rem] font-display font-black text-white/5 select-none whitespace-nowrap"
          style={{ 
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <div className="md:col-span-2">
            ...
            >
              <div className="flex items-center space-x-3 mb-6">
                ...
                <div>
                  <h3 className="text-2xl font-display font-bold">NeuroDesk</h3>
                  <p className="text-slate-400 text-sm">by SanchitVerse</p>
                </div>
              </div>
              <p className="text-slate-300 text-lg leading-relaxed mb-6 max-w-md">
                Transform your ideas into actionable plans with AI-powered intelligence. 
        ...
        >
          <div className="text-slate-400 text-sm mb-4 md:mb-0">
            © 2024 NeuroDesk by SanchitVerse. All rights reserved.
          </div>
          <div className="flex items-center space-x-6 text-sm text-slate-400">
            <span>Made with ❤️ by SanchitVerse</span>
